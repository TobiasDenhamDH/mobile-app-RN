...
export default function Menu() {
    return (
        <Tab.Navigator screenOptions={{tabBarShowLabel:false}}>
            ...
            <Tab.Screen name='Página principal' component={Home} options={{tabBarStyle:{backgroundColor:'#552586', borderTopWidth: 0}, tabBarIcon: ({focused}) => (<Foundation name='home' size={24} color={focused?"black":"white"}/>), headerStyle: {backgroundColor: '#552586'}, headerTintColor: '#fff', headerTitleStyle: {fontWeight: 'bold'},}}/>
            ...
            <Tab.Screen name='Búsqueda de usuario' component={Search} options={{tabBarStyle:{backgroundColor:'#552586'}, tabBarIcon: ({focused}) => (<Ionicons name="search-sharp" size={24} color={focused?"black":"white"} />), headerStyle: {backgroundColor: '#552586'}, headerTintColor: '#fff', headerTitleStyle: {fontWeight: 'bold'},}}/>
